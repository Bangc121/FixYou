...
public class MeetupLocationActivity extends AppCompatActivity
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        searchView.setQueryHint("주소를 검색합니다.");
        // 검색어를 입력할 때 이벤트 발생
        searchView.setOnQueryTextListener(new SearchView.OnQueryTextListener() {
            ...
            public boolean onQueryTextSubmit(String query) {
                ...
                meetup_address = splitStr[0].substring(splitStr[0].indexOf("\"") + 1,splitStr[0].length() - 2); // 주소
                ...
                markerOptions.snippet(meetup_address);
    ...
    public void onMapReady(GoogleMap googleMap) {
            ...
            if (ActivityCompat.shouldShowRequestPermissionRationale(this, REQUIRED_PERMISSIONS[0])) {
                ...
                Snackbar.make(mLayout, "이 앱을 실행하려면 위치 접근 권한이 필요합니다.",
                    ...
                    public void onClick(View view) {
                        ...
                        ActivityCompat.requestPermissions(MeetupLocationActivity.this, REQUIRED_PERMISSIONS,
        ...
        mGoogleMap.setOnInfoWindowLongClickListener(new GoogleMap.OnInfoWindowLongClickListener() {
            ...
            public void onInfoWindowLongClick(Marker marker) {
                Log.d("gi", "setOnInfoWindowLongClickListener");
                showDialog();
            }
        });
    }
    ...
    private void showDialog(){
        RxScheduler.runOnUi(o -> {
            AlertDialog.Builder addressDialog = new AlertDialog.Builder(MeetupLocationActivity.this);
            addressDialog.setTitle("주소")
                    .setMessage("주소를 등록하시겠습니까?")
                    .setPositiveButton("확인", (dialog, which) -> setAddress())   // 종료 버튼을 누르게되면 서버와 Peer 연결을 끊는 disconnect() 메소드를 호출한다.
    ...
    public void setAddress() {
        ...
        intent.putExtra("address", meetup_address);
    ...
    private void showDialogForLocationServiceSetting() {
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(MeetupLocationActivity.this);
