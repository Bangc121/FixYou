package com.example.kimjeonghwan.fixyou.utils;
...
public class RxScheduler {
    ...
    public static <T> Subscription aSyncTask(Observable.OnSubscribe<T> onSubscribe,
        ...
        return safeSubscribe(Observable.create(onSubscribe).compose(RxScheduler.applyLogicSchedulers()), onNext, onError, onCompleted);
    }
